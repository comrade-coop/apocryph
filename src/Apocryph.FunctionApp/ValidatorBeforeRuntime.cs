...
namespace Apocryph.FunctionApp
{
    public static class ValidatorBeforeRuntime
    {
        ...
        public static async Task Run([PerperStreamTrigger("ValidatorBeforeRuntime")] IPerperStreamContext context,
            [Perper("validatorFilterStream")] IAsyncEnumerable<Signed<AgentOutput>> validatorFilterStream,
