...
import type { ProviderConfig, Pod, PaymentChannelConfig } from 'trusted-pods-proto-ts'
...
export function template (): FieldOrRaw<{
  ...
  return {
    ...
    payment: {
      paymentContractAddress: hexToBytes('0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512') // TODO= result of forge create
    },
    provider: {
          ...
          ports: [
            {
              ...
              exposedPort: {
                case: 'hostHttpHost',
                value: field(`x${Math.random().toString(16).slice(2)}.podhostname.localhost`)
              }
            }
          ],
          resourceRequests: [
