...
const (
	ProvisionPodService_ProvisionPod_FullMethodName = "/apocryph.proto.v0.provisionPod.ProvisionPodService/ProvisionPod"
	ProvisionPodService_UpdatePod_FullMethodName    = "/apocryph.proto.v0.provisionPod.ProvisionPodService/UpdatePod"
	ProvisionPodService_DeletePod_FullMethodName    = "/apocryph.proto.v0.provisionPod.ProvisionPodService/DeletePod"
	ProvisionPodService_GetPodLogs_FullMethodName   = "/apocryph.proto.v0.provisionPod.ProvisionPodService/GetPodLogs"
)
...
func (c *provisionPodServiceClient) ProvisionPod(ctx context.Context, in *ProvisionPodRequest, opts ...grpc.CallOption) (*ProvisionPodResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProvisionPodService_ProvisionPod_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionPodServiceClient) UpdatePod(ctx context.Context, in *UpdatePodRequest, opts ...grpc.CallOption) (*ProvisionPodResponse, error) {
	out := new(ProvisionPodResponse)
	err := c.cc.Invoke(ctx, ProvisionPodService_UpdatePod_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionPodServiceClient) DeletePod(ctx context.Context, in *DeletePodRequest, opts ...grpc.CallOption) (*DeletePodResponse, error) {
	...
	err := c.cc.Invoke(ctx, ProvisionPodService_DeletePod_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *provisionPodServiceClient) GetPodLogs(ctx context.Context, in *PodLogRequest, opts ...grpc.CallOption) (ProvisionPodService_GetPodLogsClient, error) {
	stream, err := c.cc.NewStream(ctx, &ProvisionPodService_ServiceDesc.Streams[0], ProvisionPodService_GetPodLogs_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _ProvisionPodService_ProvisionPod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisionPodService_ProvisionPod_FullMethodName,
	}
...
func _ProvisionPodService_UpdatePod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisionPodService_UpdatePod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ProvisionPodService_DeletePod_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProvisionPodService_DeletePod_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
