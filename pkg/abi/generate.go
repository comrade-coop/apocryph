...
//go:generate abigen --pkg abi --type Registry --out ./Registry.abi.go --abi ../../contracts/out/Registry.sol/Registry.abi.json --bin ../../contracts/out/Registry.sol/Registry.bin
package abi
